...
import type { Incident, IncidentTask, IncidentTimeline, Partner } from '@/lib/supabase'
...
export default function PartnerIncidentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  ...
  async function fetchData() {
    const [partnerRes, incidentRes, tasksRes, timelineRes] = await Promise.all([
    ...
    return (
      <PartnerPortalSidebar partnerName={partner?.name} companyName={partner?.company || undefined}>
        <div className="p-6 text-center py-12">
          ...
          <Link href="/portal/partner/incidents">
